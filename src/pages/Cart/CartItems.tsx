...
const CartItems: React.FC<AppComponent> = ({ cartItems, cartRowId, totalPrice, getCart }) => {
  ...
  return (
    <>
      {!checkout ? (
        <div className="w-full md:w-11/12 xl:w-10/12 mx-auto my-4 flex flex-col md:flex-row gap-4 lg:gap-6 items-start">
          <div className="flex-1 w-full bg-white md:p-6 p-2 md:rounded-xl flex flex-col shadow-sm">
            ...
            <div className="mx-auto my-4 w-full rounded-2xl overflow-hidden border border-amber-200 bg-gradient-to-r from-amber-50 via-orange-50 to-amber-50">
              <div className="flex gap-4 px-2 md:px-5 py-2 md:py-4">
                {/* Icon column */}
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs md:text-xs font-roboto font-bold uppercase tracking-widest text-amber-700 mb-1">
                    Delivery Notice
                  </p>
                  <p className="text-xs md:text-sm font-roboto  text-amber-900 leading-relaxed">
              ...
              <div className="flex items-center gap-2 px-5 py-2.5 bg-amber-100/60 border-t border-amber-200/60">
                ...
                <p className="text-[11px] font-roboto text-amber-700">
                  Delivery fee is <span className="font-semibold">not included</span> in your
                  total
                </p>
              </div>
            </div>
          ...
          <div className="w-full md:w-[40%] lg:w-[35%] xl:w-[30%] flex flex-col">
            <div className="w-full md:sticky md:top-24 mt-4 md:mt-0 px-1 md:px-0">
              <PartnerCard />
            </div>
          </div>
        </div>
